...
public abstract class MapWinningStrategy implements WinningStrategy{
    ...
    public abstract void updateCount(Board board, Move lastMove);

    public abstract boolean checkWinner(Board board, Move lastMove);

    public abstract void handleUndo(Board board, Move lastMove);
}
